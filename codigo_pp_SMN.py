...
sbn.set(font_scale=2.5, style="whitegrid")

# Create figure and plot space
fig, ax = plt.subplots(figsize=(50, 12), facecolor='lavender')

# Add x-axis and y-axis
ax.plot(f_solo_lluvia.index,
       f_solo_lluvia['prcp'],
       color='m',
       marker = 'o',
       alpha=0.6)
...
ax.set(xlabel="Años",
       ...
       title="Ezeiza SMN- Serie de precipitación diaria\nEnero 1961 - Marzo 2023",  
       xlim=["1961", "2024"])
...
tercer_tramo= f_solo_lluvia.loc['2001-01-02':'2023-03-20'] 
